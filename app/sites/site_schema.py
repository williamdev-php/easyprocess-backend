...
class HeroData(BaseModel):
    ...
    show_cta: bool = True
    fullscreen: bool = True          # True = min-h-screen, False = half-screen
    show_gradient: bool = True       # gradient mesh / overlay on hero
...
class RankingItem(BaseModel):
    """A single ranked entry (e.g. a product, brand, or service)."""
    rank: int = 0
    title: str
    description: str = ""
    image: str | None = None
    link: CTAButton | None = None  # external link button


class RankingData(BaseModel):
    """Top-list / best-in-test section. Displays ranked items with images."""
    title: str = "Topplista"
    subtitle: str = ""
...
class SectionSettings(BaseModel):
    ...
    show_gradient: bool = True  # gradient decorations on sections
